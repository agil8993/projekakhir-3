...
<body>
			...
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					...
					<ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">
						...
						<li
							class="<?= ($this->uri->segment(2) == 'kategori' && $this->uri->segment(3) == $kate['id_kategori'] ? 'active' : '') ?>">
		...
		<div class="hero-slide">
			...
			<div class="img overlay">
				<div class="carousel-item active">
					<img src="<?= base_url('aset/upload/caraousel/' . $aa['foto']) ?>"
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12" style="margin-bottom: 30px; margin-top: -50px; ">
					<div
						style="background: #f9f9f9; padding: 20px; border-radius: 15px; box-shadow: 0px 6px 12px rgba(0, 0, 0, 0.1);">
						<h2 style="color: #333; font-weight: bold; text-align: center;">Eksplorasi Kuliner dan Cemilan
							Khas Tawangmangu</h2>
						<p style="font-size: 16px; color: #555; text-align: center; margin-top: 10px;">
							Tawangmangu, yang dikenal sebagai destinasi wisata alam, juga menawarkan beragam kelezatan
							kuliner khas yang wajib Anda coba.
							Dari kehangatan <strong>Sego Berkat Mbak Kithek</strong>, gurihnya <strong>Ayam Tim Mbok
								Iyem</strong>, hingga renyah dan manisnya
							<strong>Keripik Ubi Ungu</strong>. Setiap hidangan membawa cita rasa tradisional yang
							memanjakan lidah sekaligus menghadirkan keunikan budaya lokal.
							Jelajahi berbagai pilihan kuliner kami dan temukan cerita di balik setiap hidangan yang siap
							melengkapi perjalanan Anda di Tawangmangu.
						</p>
					</div>
				</div>
			</div>
					...
					<div class="site"
						...
						<div class="text" style="padding: 20px;">
							...
							<p style="font-size: 13px; color: #777; margin-bottom: 10px;">
								<i class="fa fa-calendar"></i> <?= date('d F Y', strtotime($uu['tanggal'])) ?>
							</p>
	...
	<div class="d-flex justify-content-center mb-10 mt-30">
		<p>
			<a href="<?= base_url('home/blog/')?>" class="btn btn-primary text-white py-3 px-4">View all content</a>
		</p>
	</div>
	</div>
